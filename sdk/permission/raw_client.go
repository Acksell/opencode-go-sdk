...
func (r *RawClient) List(
...
) (*core.Response[[]*sdk.PermissionRequest], error) {
	...
	endpointURL := baseURL + "/permission"
	...
	var response []*sdk.PermissionRequest
	...
	return &core.Response[[]*sdk.PermissionRequest]{
